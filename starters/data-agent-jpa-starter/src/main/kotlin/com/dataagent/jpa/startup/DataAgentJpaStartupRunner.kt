...
import com.dataagent.core.config.DataAgentConfigurationProcessor
import com.dataagent.jpa.service.JpaSchemaDiscoveryService
import com.dataagent.jpa.config.DataAgentJpaProperties
...
class DataAgentJpaStartupRunner(
    ...
    fun onApplicationReady() {
        logger.info("Data Agent JPA Startup Runner triggered")
    ...
    private fun getPackagesToScan(): List<String> {
        ...
        logger.warn("No packages specified for scanning. Please configure 'data-agent.jpa.scan-packages' or use @EnableDataAgent(packages = \"...\")")
        return emptyList()
    }
